...
> Warning! iNEXT takes a while to run!
...
```{r load-iNEXT-data}
load("data/05_Biodiversity/iNEXT_data.RData") ## What does this mean??
...
# Dap- included: Write to a csv file 
...
### Run Shapiro-Wilk
 **I do not have any continuous values for my data in metadata_df, so I don't know how to perform the shaprio-wilkins test**
